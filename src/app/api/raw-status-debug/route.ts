...
export async function GET(request: Request) {
  ...
  try {
    ...
    const openTrades = Array.isArray(statusApiResponse)
    ? statusApiResponse
        ...
        .map((trade: any) => ({
            ...
            openDate: trade.open_fill_timestamp
            ? new Date(trade.open_fill_timestamp).toISOString()
            : trade.open_timestamp
            ? new Date(trade.open_timestamp).toISOString()
